...
export default function Skeleton() {
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-3">
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-2xl border border-slate-200/80 bg-white px-3 dark:border-strokedark dark:bg-boxdark">
        <div className="flex shrink-0 items-center gap-2 border-b border-slate-100 px-5 py-3.5 dark:border-strokedark">
          <div className="skeleton h-5 rounded-md" style={{ width: 72 }} />
          <div className="skeleton h-5 rounded-full" style={{ width: 48 }} />
        </div>
